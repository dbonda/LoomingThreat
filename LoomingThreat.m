...
for currentTrial = 1:numTrials
    ...
    if ( currentTrial == 0 )
        ...
        sma = AddState(sma, 'Name', 'OpenField', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port1In', 'Beam1Broken', 'Port3In', 'Beam3Broken'},...
            'OutputActions', {});
        ...
        sma = AddState(sma, 'Name', 'OpenField', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port1In', 'Beam1Broken', 'Port3', 'Beam3Broken'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'Shelter', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port3In', 'Shelter3and4Broken'},...
