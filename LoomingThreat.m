...
for currentTrial = 1:numTrials
    ...
    if ( currentTrial == 0 )
        % Set global timer to 8 minutes and start the state machine 
        % Has to be implmented...
        sma = AddState(sma, 'Name', 'Start', ...
            'Timer', TaskParameters.startDelaySeconds,...
            'StateChangeConditions', {'Tup', 'exit'},...
            'OutputActions', {});
    else
        sma = AddState(sma, 'Name', 'UnknownPosition', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port1In', 'Beam1Broken', 'Port2In', 'Beam2BrokenEarly', 'Port3In', 'Beam3Broken', 'Port4In', 'Shelter'},...
            'OutputActions', {'SoftCode', TaskParameters.screenInit });
        
        sma = AddState(sma, 'Name', 'Beam1Broken', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port1Out', 'OpenField', 'Port2In', 'Threat'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'Beam2BrokenEarly', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port1In', 'Beam1and2BrokenEarly', 'Port2Out', 'ThreatZoneEarly'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'ThreatZoneEarly', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port2In', 'Beam2BrokenEarly'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'Beam1and2BrokenEarly', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port1Out', 'Beam2BrokenEarly', 'Port2Out', 'Beam1BrokenEarly'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'Beam1BrokenEarly', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port2In', 'Beam1and2BrokenEarly', 'Port1Out', 'OpenField'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'OpenField', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port1In', 'Beam1Broken', 'Port3In', 'Beam3Broken', 'GlobalTimer1_End', 'exit'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'Beam3Broken', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port3Out', 'OpenField', 'Port4In', 'Beam3and4Broken'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'Beam3and4Broken', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port3Out', 'Shelter', 'Port4Out', 'Beam3Broken'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'Shelter', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port3In', 'Shelter3and4Broken', 'GlobalTimer1_End', 'exit'},...
            'OutputActions', {'SoftCode', 2 });
        
        sma = AddState(sma, 'Name', 'Shelter3and4Broken', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port4Out', 'ResetScreen', 'Port3Out', 'Shelter'},...
            'OutputActions', {});
        
        sma = AddState(sma, 'Name', 'ResetScreen', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port3Out', 'OpenField'},...
            'OutputActions', {'SoftCode', 3 });
        
        sma = SetGlobalTimer(sma, 1, 30);
        
        sma = AddState(sma, 'Name', 'Threat', ...
            'Timer', 0,...
            'StateChangeConditions', {'Port4In', 'Shelter', 'GlobalTimer1_End', 'exit'},...
